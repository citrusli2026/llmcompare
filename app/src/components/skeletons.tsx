    ...
    <div className="min-h-screen bg-surface-base">
      ...
      <div className="px-4 py-6 sm:py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          {/* Verdict skeleton */}
          <div className="rounded-xl border border-accent-violet/20 bg-accent-violet/[0.03] p-5 mb-6">
            <SkeletonBar className="h-5 w-28 mb-3" />
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="rounded-lg border border-surface-border bg-surface-card p-3">
                <SkeletonBar className="h-4 w-32 mb-1" />
                <SkeletonBar className="h-3 w-24 mb-1" />
                <SkeletonBar className="h-3 w-16" />
              </div>
              <div className="rounded-lg border border-surface-border bg-surface-card p-3">
                <SkeletonBar className="h-4 w-28 mb-1" />
          ...
          <div className="rounded-xl border border-surface-border bg-surface-card overflow-hidden">
            <div className="flex">
              <div className="shrink-0 w-[140px] p-4 space-y-4">
                {[1, 2, 3, 4, 5].map((i) => (
              ...
              <div className="flex-1 divide-y divide-surface-border">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex p-4 gap-4">
                    <SkeletonBar className="h-4 w-16 flex-1" />
                    <SkeletonBar className="h-4 w-16 flex-1" />
                  </div>
                ))}
              </div>
